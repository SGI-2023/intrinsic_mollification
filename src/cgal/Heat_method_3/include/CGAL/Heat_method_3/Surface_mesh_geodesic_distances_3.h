...
enum MOLLIFICATION_TYPE {
  NONE,
  CONSTANT_EPSILON,
  LOCAL_CONSTANT_EPSILON,
  LOCAL_ONE_BY_ONE_STEP,
  LOCAL_ONE_BY_ONE_INTERPOLATION,
  LOCAL_LEAST_DISTANCE_MANHATTAN,
  LOCAL_LEAST_DISTANCE_EUCLIDEAN,
  GLOBAL_LEAST_DISTANCE_MANHATTAN,
  GLOBAL_LEAST_DISTANCE_EUCLIDEAN
};
...
public:
  ...
  */
  ...
  /*!
    \brief Constructor
  */
  Surface_mesh_geodesic_distances_3(const TriangleMesh& tm, MOLLIFICATION_TYPE mollification_type, double delta)
    : Surface_mesh_geodesic_distances_3(tm, get(vertex_point, tm)),
      m_mollification_type(mollification_type),
      delta(delta)
  {
    build();
  }
...
private:
  ...
  // mollification
  MOLLIFICATION_TYPE m_mollification_type;
  double delta;
  ...
  : public Surface_mesh_geodesic_distances_3<TriangleMesh, Traits, LA, VertexPointMap>
{
  ...
  Base_helper(const TriangleMesh& tm, VertexPointMap vpm, MOLLIFICATION_TYPE m_mollification_type, double delta = 1e-4)
    : type(tm, vpm, m_mollification_type, delta)
  {}

  Base_helper(const TriangleMesh& tm, MOLLIFICATION_TYPE m_mollification_type, double delta = 1e-4)
    : type(tm, m_mollification_type, delta)
  {}
...
struct Idt_storage
{
  ...
  Idt_storage(const TriangleMesh& tm, VertexPointMap vpm, MOLLIFICATION_TYPE m_mollification_type, double delta = 1e-4)
    : m_idt(tm, vpm, m_mollification_type, delta)
  {
  }

  Idt_storage(const TriangleMesh& tm, MOLLIFICATION_TYPE m_mollification_type, double delta = 1e-4)
    : m_idt(tm, m_mollification_type, delta)
  {
  }
};
                                             ...
                                             typename Intrinsic_Delaunay_triangulation_3<TriangleMesh, Traits>::Vertex_point_map>
{
  ...
  Base_helper(const TriangleMesh& tm, VertexPointMap vpm, MOLLIFICATION_TYPE m_mollification_type, double delta = 1e-4)
    : Idt_wrapper(tm, vpm, m_mollification_type, delta)
    , type(this->m_idt)
  {}

  Base_helper(const TriangleMesh& tm, MOLLIFICATION_TYPE m_mollification_type, double delta = 1e-4)
    :  Idt_wrapper(tm, m_mollification_type, delta)
    , type(this->m_idt)
  {}
...
public:
  ...
  /*!
    \brief Constructor
  */
  Surface_mesh_geodesic_distances_3(const TriangleMesh& tm, MOLLIFICATION_TYPE m_mollification_type, double delta = 1e-4)
    : Base_helper(tm, m_mollification_type, delta)
  {}

  /*!
    \brief Constructor
  */
  Surface_mesh_geodesic_distances_3(const TriangleMesh& tm, Vertex_point_map vpm, MOLLIFICATION_TYPE m_mollification_type, double delta = 1e-4)
    : Base_helper(tm, vpm, m_mollification_type, delta)
  {}
